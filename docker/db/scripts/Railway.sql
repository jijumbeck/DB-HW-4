...
ALTER TABLE "station" ADD FOREIGN KEY ("lie_in_city_name") REFERENCES "city" ("name");

ALTER TABLE "station" ADD FOREIGN KEY ("lie_in_city_region") REFERENCES "city" ("region");
